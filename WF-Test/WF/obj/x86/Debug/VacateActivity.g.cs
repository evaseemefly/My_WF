...
namespace WF {
    ...
    public partial class VacateActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(VacateActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(VacateActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(VacateActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".VacateActivity.g.xaml") || resource.Equals("VacateActivity.g.xaml"))) {
                    return resource;
                }
            }
