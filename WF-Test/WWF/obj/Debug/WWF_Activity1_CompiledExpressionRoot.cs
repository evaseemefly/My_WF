namespace WWF {
    ...
    #line 21 "D:\02编程\2016年\01协同开发\WF\WWF\Activity1.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "D:\02编程\2016年\01协同开发\WF\WWF\Activity1.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 22 "D:\02编程\2016年\01协同开发\WF\WWF\Activity1.xaml"
    ...
    #line 23 "D:\02编程\2016年\01协同开发\WF\WWF\Activity1.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 24 "D:\02编程\2016年\01协同开发\WF\WWF\Activity1.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 25 "D:\02编程\2016年\01协同开发\WF\WWF\Activity1.xaml"
    using System.Text;
    
    #line default
    #line hidden
    
    #line 26 "D:\02编程\2016年\01协同开发\WF\WWF\Activity1.xaml"
    ...
    public partial class Activity1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locations, System.Activities.ActivityContext activityContext) {
            ...
            if ((expressionId == 2)) {
                ...
                Activity1_TypedDataContext3_ForReadOnly valDataContext2 = ((Activity1_TypedDataContext3_ForReadOnly)(cachedCompiledDataContext[1]));
            ...
            if ((expressionId == 4)) {
                ...
                Activity1_TypedDataContext3_ForReadOnly valDataContext4 = ((Activity1_TypedDataContext3_ForReadOnly)(cachedCompiledDataContext[1]));
            ...
            if ((expressionId == 6)) {
                ...
                Activity1_TypedDataContext3_ForReadOnly valDataContext6 = ((Activity1_TypedDataContext3_ForReadOnly)(cachedCompiledDataContext[1]));
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.Location> locations) {
            ...
            if ((expressionId == 4)) {
                Activity1_TypedDataContext3_ForReadOnly valDataContext4 = new Activity1_TypedDataContext3_ForReadOnly(locations, true);
                return valDataContext4.ValueType___Expr4Get();
            }
            if ((expressionId == 5)) {
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            ...
            if (((isReference == false) 
                        && ((expressionText == "\"当前时间\"+InputDateTime") 
                        && (Activity1_TypedDataContext3_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 1;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "\"子线程\"+Thread.CurrentThread.ManagedThreadId.ToString()") 
                        && (Activity1_TypedDataContext3_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 2;
                return true;
            }
            ...
            if (((isReference == false) 
                        && ((expressionText == "Num>5") 
                        && (Activity1_TypedDataContext3_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 5;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "\"输入的Num为\"+Num+\"，大于5，进入状态2\"") 
                        && (Activity1_TypedDataContext3_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 6;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "Num<2&&Num!=-1") 
                        && (Activity1_TypedDataContext3_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 7;
                return true;
            }
        ...
        public System.Linq.Expressions.Expression GetExpressionTreeForExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences) {
            ...
            if ((expressionId == 4)) {
                return new Activity1_TypedDataContext3_ForReadOnly(locationReferences).@__Expr4GetTree();
            }
            if ((expressionId == 5)) {
        ...
        private class Activity1_TypedDataContext1 : Activity1_TypedDataContext0 {
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 1)].Name != "InputDateTime") 
        ...
        private class Activity1_TypedDataContext2 : Activity1_TypedDataContext1 {
            ...
            protected override void GetValueTypeValues() {
                this.Num = ((int)(this.GetVariableValue((2 + locationsOffset))));
                base.GetValueTypeValues();
            }
            
            protected override void SetValueTypeValues() {
                this.SetVariableValue((2 + locationsOffset), this.Num);
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 2)].Name != "Num") 
        ...
        private class Activity1_TypedDataContext3 : Activity1_TypedDataContext2 {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 58 "D:\02编程\2016年\01协同开发\WF\WWF\ACTIVITY1.XAML"
            ...
            internal System.Linq.Expressions.Expression @__Expr3GetTree() {
                ...
                #line 85 "D:\02编程\2016年\01协同开发\WF\WWF\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<int>> expression = () => 
                  Num;
        ...
        private class Activity1_TypedDataContext3_ForReadOnly : Activity1_TypedDataContext2_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 68 "D:\02编程\2016年\01协同开发\WF\WWF\ACTIVITY1.XAML"
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 74 "D:\02编程\2016年\01协同开发\WF\WWF\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
                "子线程"+Thread.CurrentThread.ManagedThreadId.ToString();
            ...
            internal System.Linq.Expressions.Expression @__Expr4GetTree() {
                ...
                #line 80 "D:\02编程\2016年\01协同开发\WF\WWF\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
                  TempBookMark;
            ...
            internal System.Linq.Expressions.Expression @__Expr5GetTree() {
                ...
                #line 138 "D:\02编程\2016年\01协同开发\WF\WWF\ACTIVITY1.XAML"
            ...
            internal System.Linq.Expressions.Expression @__Expr6GetTree() {
                ...
                #line 132 "D:\02编程\2016年\01协同开发\WF\WWF\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
                    "输入的Num为"+Num+"，大于5，进入状态2";
            ...
            internal System.Linq.Expressions.Expression @__Expr7GetTree() {
                ...
                #line 146 "D:\02编程\2016年\01协同开发\WF\WWF\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<bool>> expression = () => 
              Num<2&&Num!=-1;
