...
namespace HM13OA.Workflow {
    ...
    public partial class Baoxiao : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Baoxiao).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Baoxiao));
        ...
        private string FindResource() {
            string[] resources = typeof(Baoxiao).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Baoxiao.g.xaml") || resource.Equals("Baoxiao.g.xaml"))) {
                    return resource;
                }
            }
